...
//		comentarios.addComentarioLista(com3);
		...
		Respuesta res1=new Respuesta(11110101, 00001, "No tienes ni idea");
		Respuesta res2=new Respuesta(22220202, 00002, "No tienes ni idea");
		Respuesta res3=new Respuesta(33330303, 00003, "No tienes ni idea");
